    ...
    <div className="h-auto w-full max-md:max-w-full">
      <div className="bg-[rgba(36,40,15,1)] flex flex-col md:flex-row min-h-[600px] md:min-h-[816px] w-full items-center gap-8 md:gap-[40px_107px] justify-center py-12 md:py-[49px] md:pb-[99px] px-4 md:px-8 max-md:max-w-full">
        <div className="self-stretch min-w-[280px] md:min-w-60 w-full md:w-[671px] md:my-auto max-md:max-w-full">
          ...
          <button
            className="bg-[rgba(225,240,121,1)] w-[166px] max-w-full text-[15px] text-[rgba(36,40,15,1)] text-center leading-loose mt-6 py-3 rounded-[10px] border-[rgba(225,240,121,1)] border-solid border-2 hover:bg-[rgba(215,230,111,1)] transition-colors"
        ...
        <img
          ...
          className="aspect-[1.21] object-contain w-full md:w-[586px] max-w-[90%] md:max-w-full py-4 md:py-2.5"
        />
      </div>
    </div>
  );
